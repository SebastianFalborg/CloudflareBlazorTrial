...
namespace CloudflareBlazorTrial.Clients
{
    ...
    public partial class AzureFunctionsClient 
    {
        ...
        public AzureFunctionsClient(System.Net.Http.HttpClient httpClient)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<System.Collections.Generic.ICollection<PeopleDTO>>(response_, headers_, cancellationToken).ConfigureAwait(false);
        ...
        /// <returns>The OK response</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<System.DateTimeOffset> ReturnDatetimeAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            var urlBuilder_ = new System.Text.StringBuilder();
